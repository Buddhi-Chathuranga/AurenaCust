...
--  (brand_id                       TRN_MODEL_TAB.brand_id%TYPE,
--   category_id                    TRN_MODEL_TAB.category_id%TYPE,
--   model_id                       TRN_MODEL_TAB.model_id%TYPE);
...
TYPE Public_Rec IS RECORD
  (brand_id                       TRN_MODEL_TAB.brand_id%TYPE,
   ...
   model_id                       TRN_MODEL_TAB.model_id%TYPE,
   "rowid"                        rowid,
   rowversion                     TRN_MODEL_TAB.rowversion%TYPE,
   rowkey                         TRN_MODEL_TAB.rowkey%TYPE);
...
PROCEDURE Unpack___ (
   newrec_   IN OUT trn_model_tab%ROWTYPE,
...
PROCEDURE Remove___ (
   remrec_         IN OUT trn_model_tab%ROWTYPE,
   lock_mode_wait_ IN     BOOLEAN DEFAULT TRUE )
IS
   oldrec_     trn_model_tab%ROWTYPE;
BEGIN
