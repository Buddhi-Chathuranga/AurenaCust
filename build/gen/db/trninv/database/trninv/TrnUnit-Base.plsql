...
--  (unit                           TRN_UNIT_TAB.unit%TYPE);

TYPE Public_Rec IS RECORD
  (unit                           TRN_UNIT_TAB.unit%TYPE,
   "rowid"                        rowid,
   rowversion                     TRN_UNIT_TAB.rowversion%TYPE,
   rowkey                         TRN_UNIT_TAB.rowkey%TYPE);
...
PROCEDURE Unpack___ (
   newrec_   IN OUT trn_unit_tab%ROWTYPE,
...
PROCEDURE Remove___ (
   remrec_         IN OUT trn_unit_tab%ROWTYPE,
   lock_mode_wait_ IN     BOOLEAN DEFAULT TRUE )
IS
   oldrec_     trn_unit_tab%ROWTYPE;
BEGIN
